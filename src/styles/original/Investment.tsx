            ...
            <section className="relative pt-16 pb-16">
                <div className="container mx-auto px-6">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-12 mb-16 px-4 md:px-0">
                        ...
                        {/* Plan Toggle Tabs */}
                        <div className={cn(
                            "flex p-1 rounded-full border mb-4 w-full md:w-auto transition-all duration-300",
                            resolvedTheme === "dark"
                            ...
                            <button
                                ...
                                className={cn(
                                    "flex-1 md:flex-none px-6 sm:px-8 py-3 rounded-full font-display font-bold text-xs sm:text-sm transition-all",
                                    planType === "standard"
                    ...
                    <div className="transition-all duration-500">
                        {planType === "standard" ? (
                            ...
                            <div className="py-20 text-center glass-card rounded-[3rem] border-primary/30 bg-gradient-to-br from-primary/10 to-transparent">
                    ...
                    <div className="mt-24 grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className={cn("relative group p-8 sm:p-12 rounded-[2.5rem] flex flex-col items-center text-center border border-primary/30 transition-all duration-700 overflow-hidden", isDark ? "bg-[#253218]/95 hover:shadow-[0_0_40px_rgba(var(--primary-rgb),0.2)]" : "bg-[linear-gradient(135deg,rgba(252,211,77,0.08),rgba(146,64,14,0.05))] hover:shadow-[0_0_40px_rgba(252,211,77,0.1)]")}>
