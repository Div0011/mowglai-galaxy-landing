...
export default function TemplatesShowcase() {
    ...
    return (
        <div
            className="relative h-full overflow-hidden rounded-[2rem] p-4 sm:p-8 bg-card border border-white/10 group/card transition-all duration-700 hover:border-primary/40"
        ...
        >
            ...
            <div className="mt-4 flex items-center justify-between gap-3">
                <div className="flex items-center gap-2">
                    ...
                    <div className="ml-1 hidden sm:flex items-center gap-1.5">
                ...
                <Link
                    ...
                    className="group/btn relative inline-flex items-center gap-2 rounded-xl border border-primary/30 bg-primary/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-primary overflow-hidden transition-all hover:text-primary-foreground whitespace-nowrap shrink-0"
                >
