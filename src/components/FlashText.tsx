                ...
                >
                    <Magnetic>
                        <button
                            ...
                            className="group/btn relative block px-8 py-5 md:px-12 md:py-6 bg-primary text-primary-foreground font-black uppercase tracking-[0.2em] text-xs sm:text-sm md:text-lg rounded-full shadow-[0_0_30px_rgba(var(--primary-rgb),0.4)] hover:scale-105 active:scale-95 transition-all duration-300 overflow-hidden text-center cursor-pointer"
                        >
