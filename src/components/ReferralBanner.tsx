                ...
                {showButton && (
                    ...
                    >
                        <button
                            ...
                            className="[writing-mode:vertical-lr] rotate-180 bg-primary text-primary-foreground px-1 py-3 md:px-2.5 md:py-5 rounded-l-xl font-mono font-bold uppercase tracking-widest text-[8px] md:text-[10px] shadow-[-4px_0_15px_rgba(var(--primary-rgb),0.3)] hover:bg-primary/95 transition-all duration-300 border-y border-l border-primary/20 flex items-center gap-1.5 md:gap-2 whitespace-nowrap cursor-pointer"
                        >
