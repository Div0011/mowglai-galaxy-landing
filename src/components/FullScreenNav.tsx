...
import { Home, Users, Mail, DollarSign, Menu, X, Instagram, Linkedin, Layers, LayoutTemplate } from "lucide-react";
        ...
        <>
            ...
            >
                ...
                <div className="absolute inset-0 flex w-full h-full">
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <a
                                        ...
                                        className="flex flex-col items-center gap-6 text-center transition-all duration-300 cursor-pointer select-none py-4"
                                    >
                                        ...
                                        <Magnetic amount={0.3}>
                                            <span className={cn(
                                                "text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-display font-bold uppercase break-words max-w-full [writing-mode:vertical-rl] rotate-180 inline-block leading-loose py-4 px-4",
                                                isHovered
                    ...
                    {/* Mobile Navigation (Full Width Stack) */}
                    <nav className="flex md:hidden flex-col justify-center items-center w-full h-full space-y-6 pt-16 pb-28 px-6">
                        {navItems.map((item) => (
                            <a
                                key={item.label}
                                href={item.href}
                                onClick={(e) => handleClick(e, item.label, item.href)}
                                className={cn(
                                    "flex items-center gap-4 text-2xl font-display font-black tracking-[0.2em] transition-all duration-300 uppercase py-2 cursor-pointer select-none",
                                    pathname === item.href
                                        ? "text-primary scale-105"
                                        : "text-foreground/60 hover:text-primary hover:scale-105"
                                )}
                            >
                                <item.icon className="w-6 h-6 text-primary/70 shrink-0" />
